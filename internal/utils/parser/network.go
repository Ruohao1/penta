...
type HostListParser struct{} // stateless, so empty struct is fine

func NewHostListParser() *HostListParser {
	return &HostListParser{}
}

func (HostListParser) Parse(s string) ([]netip.Addr, error) {
	return ParseTargets(s)
}

var _ HostListParser = HostListParser{}

var _ Parser[[]netip.Addr] = (*HostListParser)(nil)

func ParseTargets(expr string) ([]netip.Addr, error) {
