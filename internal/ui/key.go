...
// 	homeKeyMap := views.NewHomeKeyMap()
//
// 	switch {
...
// }
//
// func (m RootModel) handleScanKey(msg tea.KeyMsg) (RootModel, tea.Cmd) {
// 	scanKeyMap := views.NewScanKeyMap()
//
// 	switch {
// 	case key.Matches(msg, scanKeyMap.Up):
// 	}
// 	// TODO: implement key handling for scan view
// 	return m, nil
// }
